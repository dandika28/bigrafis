	...
	<div class="col-lg-12">
		...
		<div class="flexigrid crud-form box" data-unique-hash="557498587ea6b8410b019e39815af033">
			<div class="box-header with-border">
				<h3 class="box-title"><i class="fa fa-plus-circle fa-fw"></i> Add PurchaseOrder </h3>
			</div>
				...
				<form action="<?php echo site_url($url) ?>" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data" accept-charset="utf-8">
					...
					<div class="row" id="no_po_field_box">
						...
						<div class="col-lg-10" id="no_po_input_box">
							<input id="field-no_po" class="form-control" name="no_po" type="text" value="" maxlength="50">				
						</div>
					</div>
					<br>
					<div class="row" id="customer_id_field_box">
						...
						<div class="col-lg-10" id="customer_id_input_box">
							<select id="field-customer_id" name="customer_id" class="chosen-select" data-placeholder="Select Customer" style="width: 300px; "><option value=""></option>
					...
					<div class="row" id="tanggal_po_field_box">
						<div class="form-display-as-box col-lg-2 control-label" id="tanggal_po_display_as_box">
							<label>
								Tanggal Purchase Order<span class="required">*</span> 					</label>
						</div>
						<div class="col-lg-10" id="tanggal_po_input_box">
							<input id="field-tanggal_po" name="tanggal_po" type="text" value="" maxlength="10" class="datepicker-input form-control">
					...
					<div class="row" id="mata_uang_field_box">
						...
						<div class="col-lg-10" id="mata_uang_input_box">
							<input id="field-mata_uang" class="form-control" name="mata_uang" type="text" value="" maxlength="50">				
						</div>
					</div>
					<br>
					<div class="row" id="tanggal_kirim_field_box">
						<div class="form-display-as-box col-lg-2 control-label" id="tanggal_kirim_display_as_box">
							<label>
								Tanggal kirim<span class="required">*</span> 					</label>
						</div>
						<div class="col-lg-10" id="tanggal_kirim_input_box">
							<input id="field-tanggal_kirim" name="tanggal_kirim" type="text" value="" maxlength="10" class="datepicker-input form-control">
							<a class="datepicker-input-clear" tabindex="-1">Clear</a> (dd/mm/yyyy)				
						</div>
					</div>
					<br>
					<div class="row" id="gudang_id_field_box">
						...
						<div class="col-lg-10" id="gudang_id_input_box">
							<select id="field-gudang_id" name="gudang_id" class="chosen-select" data-placeholder="Select Gudang" style="width: 300px;"><option value=""></option>
					...
					<div class="row" id="harga_total_field_box">
						...
						<div class="col-lg-10" id="harga_total_input_box">
							<input id="field-harga_total" class="form-control" name="harga_total" type="text" value="" maxlength="20">				
						</div>
					</div>
					<br>
					<div class="row" id="discount_field_box">
						...
						<div class="col-lg-10" id="discount_input_box">
							<input id="field-discount" class="form-control" name="discount" type="text" value="" maxlength="5">
						</div>
					</div>
					<br>
					<div class="row" id="pajak_field_box">
						...
						<div class="col-lg-1" id="pajak_input_box">
							<input id="field-pajak" class="form-control" name="pajak" type="text" value="" maxlength="2">				
						</div>
					...
					<div class="row" id="biaya_delivery_field_box">
						<div class="form-display-as-box col-lg-2 control-label" id="biaya_delivery_display_as_box">
							<label>
							Biaya delivery					</label>
						</div>
						<div class="col-lg-10" id="biaya_delivery_input_box">
							<input id="field-biaya_delivery" class="form-control" name="biaya_delivery" type="text" value="" maxlength="10">
						</div>
					</div>
					<br>
					<div class="row" id="po_status_field_box">
						...
						<div class="col-lg-10" id="po_status_input_box">
							<select id="field-po_status" name="po_status" class="chosen-select" data-placeholder="Select Po status"><option value=""></option>
							...
							<div class="set-form">
								<table id="myTable" class="table table-bordered">
									...
									<tr>
										...
										<td class="col-lg-5">
											<input id="field-jumlah_unit" class="form-control" name="jumlah_unit[]" type="text" maxlength="10">
										</td>
									</tr>
								</table>
