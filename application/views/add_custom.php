<link rel="stylesheet"
	href="<?php echo base_url('assets/grocery_crud/css/jquery_plugins/chosen/chosen.css') ?>" />
<link rel="stylesheet"
...
<div class="row">
	<div class="col-lg-12">
		<script type="text/javascript">
			var ajax_relation_url = '<?php echo base_url('Purchase/purchase_order/ajax_relation') ?>';
		</script>
		<script type="text/javascript">
			var ajax_relation_url = '<?php echo base_url('Purchase/purchase_order/ajax_relation') ?>';
		</script>
		<div class="flexigrid crud-form box"
			...
			<div class="box-header with-border">
				<h3 class="box-title">
					<i class="fa fa-plus-circle fa-fw"></i> Add PurchaseOrder
				</h3>
			</div>
				...
				<form action="<?php echo site_url($url) ?>" method="post"
					...
					<div class="row" id="no_po_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							...
							<label> Nomer Purchase Order<span class="required">*</span>
							</label>
						</div>
						<div class="col-lg-10" id="no_po_input_box">
							<input id="field-no_po" class="form-control" name="no_po"
					...
					<div class="row" id="customer_id_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="customer_id_display_as_box">
							<label> Customer </label>
						</div>
						<div class="col-lg-10" id="customer_id_input_box">
							<select id="field-customer_id" name="customer_id"
								class="chosen-select" data-placeholder="Select Customer"
								style="width: 300px;"><option value=""></option>
					...
					<div class="row" id="tanggal_po_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="tanggal_po_display_as_box">
							<label> Tanggal Purchase Order<span class="required">*</span>
							</label>
						</div>
						<div class="col-lg-10" id="tanggal_po_input_box">
							<input id="field-tanggal_po" name="tanggal_po" type="text"
								value="" maxlength="10" class="datepicker-input form-control"> <a
								class="datepicker-input-clear" tabindex="-1">Clear</a>
							(dd/mm/yyyy)
						</div>
					</div>
					<br>
					<div class="row" id="mata_uang_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="mata_uang_display_as_box">
							<label> Mata uang </label>
						</div>
						<div class="col-lg-10" id="mata_uang_input_box">
							<input id="field-mata_uang" class="form-control" name="mata_uang"
								type="text" value="" maxlength="50">
						</div>
					</div>
					<br>
					<div class="row" id="tanggal_kirim_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="tanggal_kirim_display_as_box">
							<label> Tanggal kirim<span class="required">*</span>
							</label>
						</div>
						<div class="col-lg-10" id="tanggal_kirim_input_box">
							<input id="field-tanggal_kirim" name="tanggal_kirim" type="text"
								value="" maxlength="10" class="datepicker-input form-control"> <a
								class="datepicker-input-clear" tabindex="-1">Clear</a>
							(dd/mm/yyyy)
						</div>
					...
					<div class="row" id="gudang_id_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="gudang_id_display_as_box">
							<label> Gudang </label>
						</div>
						<div class="col-lg-10" id="gudang_id_input_box">
							<select id="field-gudang_id" name="gudang_id"
								class="chosen-select" data-placeholder="Select Gudang"
								style="width: 300px;"><option value=""></option>
							<?php foreach ($gudang as $key => $value) {?>
								<option value="<?php echo $value->gudang_id;?>"><?php echo $value->gudang_name;?></option>
							<?php } ?>
							</select>
						</div>
					</div>
					...
					<div class="row" id="harga_total_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="harga_total_display_as_box">
							<label>Harga total</label>
						</div>
						<div class="col-lg-10" id="harga_total_input_box">
							<input id="field-harga_total" class="form-control"
								name="harga_total" type="text" value="" maxlength="20">
						</div>
					</div>
					<br>
					<div class="row" id="discount_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="discount_display_as_box">
							<label>Discount</label>
						</div>
						<div class="col-lg-10" id="discount_input_box">
							<input id="field-discount" class="form-control" name="discount"
					...
					<div class="row" id="pajak_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="pajak_display_as_box">
							<label>Pajak</label>
						</div>
						<div class="col-lg-1" id="pajak_input_box">
							<input id="field-pajak" class="form-control" name="pajak"
								type="text" value="" maxlength="2">
						</div>
						<div class="form-display-as-box col-lg-1"
					...
					<div class="row" id="biaya_delivery_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="biaya_delivery_display_as_box">
							<label> Biaya delivery </label>
						</div>
						<div class="col-lg-10" id="biaya_delivery_input_box">
							<input id="field-biaya_delivery" class="form-control"
								name="biaya_delivery" type="text" value="" maxlength="10">
						</div>
					</div>
					<br>
					<div class="row" id="po_status_field_box">
						<div class="form-display-as-box col-lg-2 control-label"
							id="po_status_display_as_box">
							<label> Po status </label>
						</div>
						<div class="col-lg-10" id="po_status_input_box">
							<select id="field-po_status" name="po_status"
								class="chosen-select" data-placeholder="Select Po status"><option
									value=""></option>
						...
						<div class="col-lg-12" id="product_input_box">
							<div class="set-form">
								<table id="myTable" class="table table-bordered">
									...
									<tr>
										<td class="col-lg-4"><select id="field-product"
											name="product[]" data-placeholder="Select Product"
											style="width: 100%; font-size: 14px; height: 34px; padding: 6px 12px; line-height: 1.42857143;">
												<option value="">Pilih Produk</option>
												<?php foreach ($product as $key => $value) {?>													
												<option value="<?php echo $value->product_id;?>"><?php echo $value->product_name;?></option>
												<?php } ?>
											</select></td>
										<td class="col-lg-4"><input id="field-jumlah_unit"
											class="form-control" name="jumlah_unit[]" type="text"
											maxlength="10"></td>
										<td class="col-lg-4"><input id="field-harga_satuan"
											class="form-control" name="harga_satuan[]" type="text"
											maxlength="10"></td>
									</tr>
								</table>
								<div class="set-formn text-center">
									<div class="col-lg-6">
										<button type="button" id="more_fields" onclick="add_fields();"
											class="btn btn-info">Add More</button>
									</div>
									<div class="col-lg-6">
										<button type="button" id="more_fields"
											onclick="delete_fields();" class="btn btn-info">Delete</button>
									</div>
								</div>
							</div>
						</div>
					...
					<input id="field-created_by" type="hidden" name="created_by"
						value="1" />
					<!-- End of hidden inputs -->
					<div id="report-error" class="report-div error alert alert-danger"
						role="alert"></div>
					...
					<span class="small-loading" id="FormLoading"><img
						src="http://localhost/bigrafis/assets/svg/loading-spin-primary.svg"
