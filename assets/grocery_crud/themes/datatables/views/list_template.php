<?php
	...
	$this->set_css('assets/metronic/css/components.css');
		...
		<div class="flexigrid" data-unique-hash="<?php echo $unique_hash; ?>">
			...
			<div class="tDiv row">
				<div class="tDiv2 col-xs-6">
					<?php if(!$unset_add){?>
					<!-- Button ADD  -->
			        	<a href='<?php if($subject!='PurchaseOrder'){echo $add_url;}else{echo base_url('index.php/Purchase/purchase_order_add');}?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='add-anchor add_button btn btn-primary'>
