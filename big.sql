...
REPLACE INTO `company` (`company_id`, `name`, `address`, `status`) VALUES
...
-- Dumping data for table big.customer: ~2 rows (approximately)
/*!40000 ALTER TABLE `customer` DISABLE KEYS */;
REPLACE INTO `customer` (`id`, `customer_name`, `customer_contact`, `customer_address`, `customer_phone`, `customer_email`, `customer_fax`, `customer_city`, `customer_country`, `customer_kode`, `customer_postal`, `created_by`, `modified_at`) VALUES
	...
	(2, 'SWATCH International', 'Mr. Watch', 'Switzerland', '+44 0444 25678', 'watch@swatch.com', '+44 0444 25677', 'Lausanne', 'Switzerland', '99', '123456', '1', '2018-04-18 15:32:20');
...
-- Dumping data for table big.groups: ~11 rows (approximately)
...
-- Dumping data for table big.groups_header: ~9 rows (approximately)
/*!40000 ALTER TABLE `groups_header` DISABLE KEYS */;
REPLACE INTO `groups_header` (`id_header_menu`, `id_groups`) VALUES
	(0, 1),
	(1, 1),
	(1, 2),
	(1, 7),
...
-- Dumping data for table big.groups_menu: ~83 rows (approximately)
/*!40000 ALTER TABLE `groups_menu` DISABLE KEYS */;
REPLACE INTO `groups_menu` (`id_groups`, `id_menu`) VALUES
	(1, 83),
	(2, 83),
	(1, 85),
	(1, 92),
...
REPLACE INTO `gudang` (`gudang_id`, `gudang_name`, `desc`, `created_by`, `modified_at`) VALUES
	(1, 'Gudang', 'Gudang', '1', '2018-04-16 16:30:21'),
	(2, 'Gudang Produksi', 'Penyimpanan FG sebelum diserahkan ke Gudang', '1', '2018-04-16 16:33:01'),
	(3, 'WIP', 'WIP', '1', '2018-08-11 14:22:26');
...
REPLACE INTO `header_menu` (`id_header_menu`, `sort`, `header`) VALUES
	(1, 1, 'MAIN NAVIGATION');
...
-- Dumping data for table big.material: ~728 rows (approximately)
/*!40000 ALTER TABLE `material` DISABLE KEYS */;
REPLACE INTO `material` (`id`, `kode`, `material_name`, `satuan`, `gudang_id`, `created_by`, `modified_at`, `category_id`, `harga_satuan`) VALUES
	...
	(726, 111, '111', 'rim', '2', '1', '2018-08-15 20:15:55', 3, 345),
	(727, 1234, '1234', 'rim', '1', '1', '2018-08-15 20:18:18', 3, 100000),
	(728, 4321, '4321_jajal', 'rim', '1', '1', '2018-08-15 20:22:24', 3, 100000);
...
-- Dumping data for table big.material_category: ~13 rows (approximately)
/*!40000 ALTER TABLE `material_category` DISABLE KEYS */;
REPLACE INTO `material_category` (`id`, `material_category_name`, `createdby`, `modified_at`) VALUES
...
-- Dumping data for table big.menu: ~27 rows (approximately)
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
REPLACE INTO `menu` (`id_menu`, `sort`, `id_header_menu`, `label`, `icon`, `url`, `menu_id`, `level_one`, `level_two`) VALUES
...
REPLACE INTO `mesin` (`id`, `mesin_name`, `mesin_type`, `desc`, `created_by`, `modified_at`) VALUES
...
REPLACE INTO `mesin_category` (`categorymesinid`, `category`, `createdby`, `modified_at`) VALUES
...
-- Dumping data for table big.nota_transfer: ~32 rows (approximately)
/*!40000 ALTER TABLE `nota_transfer` DISABLE KEYS */;
REPLACE INTO `nota_transfer` (`id`, `spk_induk`, `status`, `created_by`, `modified_at`) VALUES
	...
	(10006, 246, 'OK', '1', '2018-07-02 09:24:51'),
	(10007, 0, 'OK', '1', '2018-07-02 09:24:52'),
	(10008, 246, 'OK', '1', '2018-07-02 09:36:59'),
	(10009, 0, 'OK', '1', '2018-07-02 09:37:00'),
	(10010, 246, 'OK', '1', '2018-07-02 09:37:25'),
	(10011, 0, 'OK', '1', '2018-07-02 09:37:26'),
	(10012, 246, 'OK', '1', '2018-07-02 09:48:21'),
	(10013, 0, 'OK', '1', '2018-07-02 09:48:22'),
	(10014, 246, 'OK', '1', '2018-07-02 09:50:42'),
	(10015, 246, 'OK', '1', '2018-07-02 09:51:34'),
	(10016, 246, 'OK', '1', '2018-07-02 09:53:40'),
	(10017, 0, 'OK', '1', '2018-07-02 09:53:41'),
	(10018, 246, 'OK', '1', '2018-07-02 09:55:23'),
	(10019, 0, 'OK', '1', '2018-07-02 09:55:24'),
	(10020, 246, 'OK', '1', '2018-07-02 09:56:11'),
	(10021, 0, 'OK', '1', '2018-07-02 09:56:12'),
	(10022, 246, 'OK', '1', '2018-07-02 10:35:12'),
	(10023, 0, 'OK', '1', '2018-07-02 10:35:12'),
	(10024, 274, 'OK', '1', '2018-07-04 11:53:44'),
	(10025, 0, 'OK', '1', '2018-07-04 11:53:44'),
	(10026, 277, 'OK', '1', '2018-08-11 12:43:49'),
	(10027, 0, 'OK', '1', '2018-08-11 12:43:51'),
	(10028, 277, 'OK', '1', '2018-08-11 12:44:44'),
	(10029, 0, 'OK', '1', '2018-08-11 12:44:47'),
	(10030, 277, 'OK', '1', '2018-08-11 14:00:22'),
	(10031, 0, 'OK', '1', '2018-08-11 14:00:25'),
	(10032, 277, 'OK', '1', '2018-08-16 11:53:16'),
	(10033, 0, 'OK', '1', '2018-08-16 11:53:17');
...
-- Dumping data for table big.nota_transfer_material: ~45 rows (approximately)
/*!40000 ALTER TABLE `nota_transfer_material` DISABLE KEYS */;
REPLACE INTO `nota_transfer_material` (`nota_id`, `spk_material_id`, `qty_deliver`, `mesin_id`, `keterangan`) VALUES
	(10000, 6, 7, NULL, NULL),
	(10000, 7, 8, NULL, NULL),
	(10002, 6, 4, NULL, NULL),
	(10002, 7, 2, NULL, NULL),
	...
	(10006, 6, 1, NULL, NULL),
	(10006, 7, 1, NULL, NULL),
	(10008, 6, 250, NULL, NULL),
	(10008, 7, 40, NULL, NULL),
	(10010, 6, 10, NULL, NULL),
	(10010, 7, 90, NULL, NULL),
	(10012, 6, 40, NULL, NULL),
	(10012, 7, 40, NULL, NULL),
	(10014, 6, 32, NULL, NULL),
	(10015, 6, 32, NULL, NULL),
	(10016, 6, 0, NULL, NULL),
	(10016, 7, 32, NULL, NULL),
	(10018, 6, 0, NULL, NULL),
	(10018, 7, 32, NULL, NULL),
	(10020, 6, 0, NULL, NULL),
	(10020, 7, 5, NULL, NULL),
	(10022, 6, 0, NULL, NULL),
	(10022, 7, 63, NULL, NULL),
	(10024, 47, 50, NULL, NULL),
	(10024, 48, 250, NULL, NULL),
	(10026, 53, 29, NULL, NULL),
	(10026, 54, 5, NULL, NULL),
	(10026, 55, 2, NULL, NULL),
	(10026, 56, 2, NULL, NULL),
	(10026, 57, 2, NULL, NULL),
	(10028, 53, 0, NULL, NULL),
	(10028, 54, 1, NULL, NULL),
	(10028, 55, 0, NULL, NULL),
	(10028, 56, 0, NULL, NULL),
	(10028, 57, 0, NULL, NULL),
	(10030, 53, 0, NULL, NULL),
	(10030, 54, 0, NULL, NULL),
	(10030, 55, 0, NULL, NULL),
	(10030, 56, 0, NULL, NULL),
	(10030, 57, 0, NULL, NULL),
	(10030, 58, 10, NULL, NULL),
	(10032, 53, 0, NULL, NULL),
	(10032, 54, 0, NULL, NULL),
	(10032, 55, 0, NULL, NULL),
	(10032, 56, 0, NULL, NULL),
	(10032, 57, 0, NULL, NULL),
	(10032, 58, 10, NULL, NULL);
...
-- Dumping data for table big.notification: ~39 rows (approximately)
/*!40000 ALTER TABLE `notification` DISABLE KEYS */;
REPLACE INTO `notification` (`notification_id`, `notif`, `type`, `group_id`, `subject`, `date`, `status`) VALUES
	(1, 'Anda mendapat PO Baru dari bagian Sales/Marketing', 'PO', '3', 'PO Baru Nomer ', '2018-04-08 09:51:49', 'R'),
	(2, 'Anda mendapat PO Baru dari bagian Sales/Marketing', 'PO', '3', 'PO Baru Nomer PO/031/II/2018', '2018-04-08 09:51:49', 'R'),
	...
	(15, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-18 16:04:53', 'N'),
	(16, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 11:38:06', 'N'),
	(17, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 11:38:07', 'N'),
	(18, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:25:57', 'N'),
	(19, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:35:00', 'N'),
	(20, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:35:41', 'N'),
	(21, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:35:42', 'N'),
	(22, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:36:57', 'N'),
	(23, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:36:57', 'N'),
	(24, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:36:59', 'N'),
	(25, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-04-24 15:37:25', 'N'),
	(26, 'SPK Induk  Proses potong Di assign ke bagian Anda', 'potong', '8', 'SPK Proses potong Baru', '2018-07-01 17:13:20', 'R'),
	(27, 'SPK Induk  Proses potong Di assign ke bagian Anda', 'potong', '8', 'SPK Proses potong Baru', '2018-07-01 17:13:20', 'R'),
	(28, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-06-07 11:56:42', 'N'),
	(29, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-06-07 11:56:44', 'N'),
	(30, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-06-29 14:33:10', 'N'),
	(31, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-07-03 11:20:35', 'N'),
	(32, 'Anda mendapat SPK Baru dari bagian Production', 'SPKINDUK', '5', 'SPK Induk Baru Nomer ', '2018-07-03 13:53:21', 'N'),
	(33, 'SPK Induk  Proses potong Di assign ke bagian Anda', 'potong', '8', 'SPK Proses potong Baru', '2018-08-11 12:13:32', 'R'),
	(34, 'SPK Induk  Proses cetak Di assign ke bagian Anda', 'cetak', '8', 'SPK Proses cetak Baru', '2018-08-11 14:33:43', 'R'),
	(35, 'SPK Induk  Proses coating Di assign ke bagian Anda', 'coating', '8', 'SPK Proses coating Baru', '2018-08-11 14:33:43', 'R'),
	(36, 'SPK Induk  Proses pond Di assign ke bagian Anda', 'pond', '8', 'SPK Proses pond Baru', '2018-08-11 14:33:43', 'R'),
	(37, 'SPK Induk  Proses sortir Di assign ke bagian Anda', 'sortir', '8', 'SPK Proses sortir Baru', '2018-08-11 14:33:43', 'R'),
	(38, 'SPK Induk  Proses gluing Di assign ke bagian Anda', 'gluing', '8', 'SPK Proses gluing Baru', '2018-08-11 14:33:43', 'R'),
	(39, 'SPK Induk  Proses packing Di assign ke bagian Anda', 'packing', '8', 'SPK Proses packing Baru', '2018-08-11 14:33:43', 'R');
...
REPLACE INTO `operatormesin` (`id`, `operatorname`, `created_by`, `modified_at`, `jobfinish`, `role`) VALUES
	(1, 'Dika', '1', '2018-03-10 12:17:16', 1000002, 2),
	(2, 'Deki', '1', '2018-03-11 08:21:20', 2263523, 2),
	(3, 'wawan', '1', '2018-07-11 21:05:29', 19501, 6),
	...
	(12, 'Ramdhani', '1', '2018-08-11 12:21:53', 14500, 1),
	...
	(18, 'Turiman', '1', '2018-08-11 12:23:14', 14500, 8),
	...
	(34, 'Ipan Sopian', '1', '2018-08-11 12:12:35', 45000, 5),
	(35, 'Johan Susanto', '1', '2018-03-16 21:04:19', 0, 5),
	(36, 'Muhamad Roi', '1', '2018-03-16 21:04:26', 0, 5),
	(37, 'Muradi', '1', '2018-08-11 12:22:35', 14500, 2),
...
-- Dumping data for table big.po: ~9 rows (approximately)
/*!40000 ALTER TABLE `po` DISABLE KEYS */;
REPLACE INTO `po` (`id`, `no_po`, `customer_id`, `tanggal_po`, `mata_uang`, `tanggal_kirim`, `gudang_id`, `product_id`, `harga_total`, `discount`, `pajak`, `biaya_delivery`, `jumlah_unit`, `harga_satuan`, `po_status`, `created_by`, `modified_at`) VALUES
	(1, 'PO026/XII/17', 1, '2017-11-01', 'IDR', '2018-01-31', '2', '1', '', '', '', '', '10000000', NULL, '', '1', '2018-04-04 06:15:24'),
	(2, 'PO027/V/2018', 1, '2018-02-22', 'IDR', '2018-02-28', '2', '5,18', '20000000', '1', '10', '120000', '1000000,50', NULL, 'New', '1', '2018-04-04 06:05:39'),
	(3, 'PO024/XII/17', 1, '2017-07-05', 'IDR', '2018-05-31', '2', '18,17,10', '34000000000', '10', '10', '0', '500000,200', NULL, 'New', '1', '2018-04-04 06:16:21'),
	(4, 'PO/031/II/2018', 1, '2018-02-14', 'IDR', '2018-02-28', '2', '1', '10000000', '1', '1', '100', '30000', NULL, 'New', '1', '2018-02-24 15:35:53'),
	(7, 'PO-2018TEST01', 2, '2018-04-23', 'IDR', '2018-05-10', '1', '175,176', '270000000', '0', '0', '3000000', '1000000,10', NULL, 'New', '1', '2018-04-24 15:23:04'),
	(8, 'PO-2018TEST02', 2, '2018-04-24', 'IDR', '2018-05-10', '1', '177,176', '94500000', '0', '0', '1500000', '350000,350', NULL, 'New', '1', '2018-04-24 15:25:01'),
	(9, 'PO036/XV/2018', 1, '2018-06-29', 'IDR', '2018-06-30', '1', '11,2,74', '1000000000', '10', '10', '1000000', '150,250,950', NULL, 'New', '1', '2018-06-29 17:00:29'),
	(10, 'PO028/XXI/12738', 1, '2018-06-29', 'IDR', '2018-06-29', '1', '3,13,84', '500000000', '10000', '10', '1000000', '1000,2000,100', '100000,100000,2000000', 'New', '1', '2018-06-29 17:18:16'),
	(12, 'PO0518-014569', 1, '2018-05-23', 'IDR', '2018-10-01', '2', '21', '393075000', '', '10', '', '262500', '150', 'New', '1', '2018-08-11 11:04:48');
...
-- Dumping data for table big.po_product: ~17 rows (approximately)
/*!40000 ALTER TABLE `po_product` DISABLE KEYS */;
REPLACE INTO `po_product` (`po_product_id`, `po_id`, `product_id`, `jumlah_unit`, `harga_satuan`) VALUES
	(11, 2, '5', '1000000', NULL),
	(12, 2, '18', '500000', NULL),
	(13, 1, '1', '10000000', NULL),
	(14, 3, '18', '500000', NULL),
	(15, 3, '17', '200000', NULL),
	(16, 3, '10', '4500000', NULL),
	(21, 7, '175', '1000000', NULL),
	(22, 7, '176', '1000000', NULL),
	(23, 8, '177', '350000', NULL),
	(24, 8, '176', '350000', NULL),
	(25, 9, '11', '150', NULL),
	(26, 9, '2', '250', NULL),
	(27, 9, '74', '950', NULL),
	(28, 10, '3', '1000', '100000'),
	(29, 10, '13', '2000', '100000'),
	(30, 10, '84', '100', '2000000'),
	(35, 12, '21', '262500', '150');
...
-- Dumping data for table big.product: ~176 rows (approximately)
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
REPLACE INTO `product` (`product_id`, `product_kode`, `product_name`, `product_category`, `product_desc`, `product_price`, `product_unit`, `created_by`, `modified_at`) VALUES
	...
	(175, 999, 'SWATCH - Outer Box - Green', '9', '<p>Kotak Jam Tangan Bagian Luar</p>\r\n', '200', 'Set', '1', '2018-04-24 11:05:30'),
	(176, 999, 'SWATCH - Inner Box', '9', '<p>Kotak Jam Tangan Bagian Dalam</p>\r\n', '65', 'Set', '1', '2018-04-18 15:29:45'),
	(177, 999, 'SWATCH - Outer Box - Red', '9', '<p>Kotak Jam Tangan Bagian Luar varian RED</p>\r\n', '200', 'set', '1', '2018-04-24 11:08:28');
...
-- Dumping data for table big.product_category: ~10 rows (approximately)
/*!40000 ALTER TABLE `product_category` DISABLE KEYS */;
REPLACE INTO `product_category` (`categoryproductid`, `category`, `createdby`, `modified_at`) VALUES
	(1, 'Kosmetik', '1', '2018-04-18 15:22:47'),
	(2, 'Rokok', '1', '2018-04-18 15:22:22'),
	(3, 'Sabun', '1', '2018-04-18 15:21:58'),
	(4, 'Makanan-Minuman', '1', '2018-04-18 15:21:32'),
	(5, 'Mainan', '1', '2018-04-18 15:23:00'),
	(6, 'ATK', '1', '2018-04-18 15:23:33'),
	(7, 'Buku', '1', '2018-04-18 15:23:53'),
	(8, 'Lain-lain', '1', '2018-04-18 15:24:07'),
	(9, 'Fashion', '1', '2018-04-18 15:25:26'),
	(10, 'Otomotif', '1', '2018-04-18 15:25:39');
...
REPLACE INTO `proses` (`id`, `proses`) VALUES
	(1, 'cetak'),
	(2, 'coating'),
	(4, 'hot-stamping'),
	(5, 'potong'),
...
REPLACE INTO `settings` (`id_settings`, `judul`, `nama_perusahaan`, `alamat`, `logo`, `skin`) VALUES
...
REPLACE INTO `settings_orig` (`id_settings`, `judul`, `nama_perusahaan`, `alamat`, `logo`, `skin`) VALUES
...
-- Dumping data for table big.spk_induk: ~26 rows (approximately)
/*!40000 ALTER TABLE `spk_induk` DISABLE KEYS */;
REPLACE INTO `spk_induk` (`spk_induk_id`, `po_id`, `spk_date`, `description`, `gudang_asal`, `gudang_tujuan`, `spk_status`, `status`, `created_by`, `modified_at`, `qty_order`, `product_code`) VALUES
	(246, 3, '2018-02-21', 'OLIVE SABUN 70 YELLOW', '3', '2', 'New', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(247, 1, '2018-01-30', 'pro ares mulut tenggorokan qty100000', '3', '1', 'WIP', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(248, 2, '2018-02-22', 'mohon di kejar ', '3', '2', 'WIP', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(249, 1, '2018-03-10', 'test', '3', '1', 'New', 1, '1', '2018-03-16 17:23:57', 0, 0),
	(250, 2, '2018-03-16', 'test', '3', '2', 'New', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(251, 5, '2018-04-06', 'SWATCH - Outer Box', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(252, 5, '2018-04-24', '', '', '', 'New', 1, '', '2018-08-15 19:25:42', 0, 0),
	(253, 5, '2018-04-24', 'SWATCH - Outer Box - Green', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(254, 7, '2018-04-24', 'SWATCH - Outer Box - Green', '1', '2', 'New', 1, '1', '2018-04-24 15:25:57', 0, 0),
	(255, 8, '2018-04-24', 'SWATCH - Outer Box - Red', '1', '2', 'New', 1, '1', '2018-04-24 15:35:00', 0, 0),
	(256, 7, '2018-04-24', '', '', '', 'New', 1, '', '2018-08-15 19:25:42', 0, 0),
	(257, 7, '2018-04-24', 'SWATCH - Outer Box - Green', '1', '2', 'New', 1, '1', '2018-04-24 15:35:42', 0, 0),
	(258, 7, '2018-04-24', 'SWATCH - Inner Box', '1', '2', 'New', 1, '1', '2018-04-24 15:36:57', 0, 0),
	(259, 7, '2018-04-24', '', '', '', 'New', 1, '', '2018-08-15 19:25:42', 0, 0),
	(260, 7, '2018-04-24', 'SWATCH - Inner Box', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 0, 0),
	(261, 8, '2018-04-24', 'SWATCH - Inner Box', '1', '2', 'New', 1, '1', '2018-04-24 15:37:25', 0, 0),
	(262, 3, '0000-00-00', '', '', '', 'New', 1, '', '2018-08-15 19:25:42', 0, 0),
	(263, 3, '2018-06-06', 'BLANK ROKOK LUFFMAN', '1', '2', 'WIP', 1, '1', '2018-06-07 11:56:44', 0, 0),
	(264, 8, '2018-06-08', 'SWATCH - Outer Box - Red', '1', '2', 'New', 1, '1', '2018-06-29 14:33:10', 0, 0),
	(265, 12, '2018-07-03', 'KAMUS ARAB INDONESIA', '1', '2', 'New', 1, '1', '2018-07-03 11:20:35', 3000, 1000020),
	(266, 11, '2018-07-03', 'OLIVE RED 125 GR', '1', '2', 'New', 1, '1', '2018-07-03 16:37:14', 100, 1000010),
	(274, 11, '2018-07-03', 'BLANK ROKOK H-MILD', '1', '2', 'New', 1, '1', '2018-07-04 11:53:44', 250, 1000053),
	(275, 12, '2018-08-11', 'ESM AYU PINK 80GR', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 262500, 1000020),
	(276, 12, '2018-08-11', 'ESM AYU PINK 80GR', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 262500, 1000020),
	(277, 12, '2018-08-11', 'ESM AYU PINK 80GR', '2', '2', 'WIP', 2, '1', '2018-08-16 11:53:17', 262500, 1000020),
	(278, 12, '2018-08-15', 'ESM AYU PINK 80GR', '1', '2', 'New', 1, '1', '2018-08-15 19:25:42', 1000000, 1000020);
...
-- Dumping data for table big.spk_material: ~0 rows (approximately)
/*!40000 ALTER TABLE `spk_material` DISABLE KEYS */;
REPLACE INTO `spk_material` (`spk_induk_id`, `spk_material_id`, `kode_material`, `jumlah_material`, `satuan`, `gudang_id`, `qty_deliver`, `harga_material_satuan`) VALUES
	(247, 1, 2, 2, 'Kg', '1', 1, NULL),
	(247, 2, 1, 20, 'Riem', '1', 10, NULL),
	(247, 3, 1, NULL, 'Riem', '1', 78, NULL),
	(247, 4, 2, 777777, 'Riem', '3', 13332, NULL),
	(248, 5, 187, 30000, 'lbr', '3', 200, NULL),
	(246, 6, 185, 1000, 'Riem', '1', 900, NULL),
	(246, 7, 13, 1000, 'Kg', '1', 900, NULL),
	(249, 8, 8, 15, 'Liter', '3', 1312, NULL),
	(249, 9, 57, 1000, 'Riem', '3', 1311, NULL),
	(249, 10, 10, 2, 'Kg', '3', 1312, NULL),
	(251, 11, 456, 500, 'Riem', '2', NULL, NULL),
	(NULL, 13, 291, 350, NULL, NULL, NULL, NULL),
	(253, 14, 291, 350, 'Riem', '1', NULL, NULL),
	(253, 15, 105, 2, 'Kg', '1', NULL, NULL),
	(NULL, 16, 106, 2, NULL, NULL, NULL, NULL),
	(253, 17, 106, 2, 'Kg', '1', NULL, NULL),
	(253, 18, 107, 2, 'Kg', '1', NULL, NULL),
	(253, 19, 108, 2, 'Kg', '1', NULL, NULL),
	(253, 20, 696, 53, 'Kg', '1', NULL, NULL),
	(254, 21, 291, 350, 'Riem', '1', NULL, NULL),
	(254, 22, 105, 2, 'Kg', '1', NULL, NULL),
	(254, 23, 106, 2, 'Kg', '1', NULL, NULL),
	(254, 24, 107, 2, 'Kg', '2', NULL, NULL),
	(254, 25, 108, 2, 'Kg', '1', NULL, NULL),
	(254, 26, 696, 53, 'Kg', '1', NULL, NULL),
	(NULL, 27, 123, 35, NULL, NULL, NULL, NULL),
	(255, 28, 123, 35, 'Kg', '1', NULL, NULL),
	(NULL, 29, 291, 95, NULL, NULL, NULL, NULL),
	(257, 30, 291, 190, 'Riem', '1', NULL, NULL),
	(NULL, 31, 105, 1, NULL, NULL, NULL, NULL),
	(257, 32, 105, 1, 'Kg', '1', NULL, NULL),
	(257, 33, 106, 1, 'Kg', '1', NULL, NULL),
	(NULL, 34, 107, 1, NULL, NULL, NULL, NULL),
	(257, 35, 107, 1, 'Kg', '1', NULL, NULL),
	(NULL, 36, 108, 1, NULL, NULL, NULL, NULL),
	(257, 37, 108, 1, 'Kg', '1', NULL, NULL),
	(NULL, 38, 696, 48, NULL, NULL, NULL, NULL),
	(257, 39, 696, 48, 'Kg', '1', NULL, NULL),
	(NULL, 40, 288, 100, NULL, NULL, NULL, NULL),
	(258, 41, 288, 100, 'Riem', '1', NULL, NULL),
	(261, 42, 288, 35, 'Riem', '1', NULL, NULL),
	(264, 43, 2, 1, 'Riem', '1', NULL, 100000),
	(265, 44, 20, 1000, 'lbr', '1', NULL, 50000),
	(265, 45, 34, 150, 'Riem', '2', NULL, 500000),
	(265, 46, 294, 25, 'lbr', '2', NULL, 1000000),
	(274, 47, 42, 100, 'Kg', '1', 50, 150000),
	(274, 48, 126, 500, 'pcs', '1', 250, 25000),
	(266, 49, 447, 29, 'Riem', '1', NULL, NULL),
	(266, 50, 134, 5, 'Kg', '1', NULL, NULL),
	(266, 51, 123, 35, 'Kg', '1', NULL, NULL),
	(266, 52, 189, 6, 'Kg', '1', NULL, NULL),
	(277, 53, 448, 29, 'Riem', '2', 29, 1300000),
	(277, 54, 189, 5, 'Kg', '2', 6, 150000),
	(277, 55, 106, 2, 'Kg', '2', 2, 90000),
	(277, 56, 105, 2, 'Kg', '2', 2, 90000),
	(277, 57, 107, 2, 'Kg', '2', 2, 90000),
	(277, 58, 7, 20, 'Kg', '2', 20, 20000),
	(246, 59, 728, 5000, 'Liter', '1', NULL, 10000),
	(246, 60, 728, 13, 'Liter', '1', NULL, NULL),
	(246, 61, 728, 15, 'Liter', '1', NULL, NULL),
	(246, 62, 728, 16, 'Liter', '2', NULL, NULL),
	(246, 63, 728, 17, 'Kg', '1', NULL, NULL),
	(246, 64, 728, 6, 'Liter', '2', NULL, NULL),
	(246, 65, 728, 22, 'Liter', '2', NULL, NULL),
	(246, 66, 728, 77, 'Liter', '2', NULL, NULL),
	(246, 67, 728, 999, 'Liter', '1', NULL, NULL),
	(246, 68, 728, 876, 'Liter', '1', NULL, NULL),
	(246, 69, 728, 123, 'Liter', '1', NULL, NULL),
	(246, 70, 728, 878, 'Liter', '1', NULL, NULL),
	(247, 71, 728, 123, 'Riem', '1', NULL, 100000),
	(249, 72, 728, 123, 'Liter', '1', NULL, 100000);
...
-- Dumping data for table big.spk_proses_mesin: ~0 rows (approximately)
/*!40000 ALTER TABLE `spk_proses_mesin` DISABLE KEYS */;
REPLACE INTO `spk_proses_mesin` (`spk_proses_id`, `proses_type`, `spk_induk`, `mesin_id`, `qty_order`, `qty_finish`, `qty_reject`, `nama_kertas`, `ukuran_kertas`, `jumlah`, `warna`, `catatan_khusus`, `created_by`, `modified_at`, `created_at`, `status_spk`, `ukuran_kertas_plano`, `description`, `ukuran_kertas_potong`, `varnish_type`, `lem_type`, `proses_ke_mesin`, `operator_mesin`) VALUES
	(1, '2', 247, 4, 600000, 556725, 0, 'ivory', '72x56', '110000', 'C,M,Y,K,', 'perhatikan register, warna dan hasil cetakan', '1', '2018-07-04 17:22:09', '2018-01-30 16:49:55', 'Hold', '', 'mesin rusak', '', '', NULL, NULL, '2'),
	(2, '1', 247, 1, 50000, 55000, 0, 'IVORY IP 230 72x113', '40x40', '200', 'putih', 'harap yang rapi yaa', '1', '2018-03-11 08:22:18', '2018-02-15 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '1'),
	(3, '2', 247, 11, 5000, 3000, 0, '', '', '5000', '', 'yg rapih', '1', '2018-03-10 06:33:44', '2018-02-19 00:00:00', 'WIP', '', '', '', 'doft', NULL, NULL, '2'),
	(4, '5', 247, 27, 100000, 35000, 0, 'A4', '', '20 rim', '', '', '1', '2018-02-19 22:49:34', '2018-02-19 00:00:00', 'WIP', '4x4', '', '2x2', '', NULL, '1', '2'),
	(5, '6', 247, 20, 20000, 5500, 500, '', '', '20000', '', 'rapet yaa', '1', '2018-07-11 21:35:11', '2018-02-16 00:00:00', 'Finish', '', '', '', '', 'aibon', NULL, '3'),
	(6, '1', 248, 2, 8000, 6811, 0, 'A4', '20x20', '8800', 'c,m.y,k', 'dominan kanan', '1', '2018-02-21 08:50:30', '2018-02-21 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '2'),
	(7, '2', 248, 4, 20000, 20050, 0, '', '', '', '', '', '1', '2018-03-11 08:21:20', '0000-00-00 00:00:00', 'WIP', '', '', '', '', NULL, NULL, '2'),
	(8, '6', 248, 20, 12000, 1500, 0, '', '', '44444', '', '', '1', '2018-02-21 16:37:33', '2018-02-21 00:00:00', 'WIP', '', '4444', '', '', 'keut', NULL, '3'),
	(9, '5', 246, 26, 100000, 3500, 0, 'c', '', '111111', '', 'c', '1', '2018-03-11 08:18:42', '2018-02-22 00:00:00', 'WIP', '2x2', 'bbbb', '3x3', '', NULL, '8', '6'),
	(10, '9', 247, 0, 100000, 0, 0, '', '', '100000', '', '', '1', '2018-02-24 16:06:23', '2018-02-21 00:00:00', 'New', '', '', '', '', NULL, NULL, NULL),
	(11, '1', 249, 1, 1000000, 100000, 0, 'test', '2x5', '1000', 'cmyk', 'glossy', '1', '2018-03-10 11:28:43', '2018-03-10 00:00:00', 'WIP', '', '', '', '', NULL, NULL, '1'),
	(12, '5', 249, 27, 1000000, 0, 0, 'plano', '', '3000', '', '', '1', '2018-03-10 11:47:59', '2018-03-10 00:00:00', 'New', '3x4', '', '1x2', '', NULL, '3', NULL),
	(13, '2', 249, 4, 10000, 0, 0, '', '', '', '', '', '1', '2018-03-10 12:02:51', '2018-03-10 00:00:00', 'New', '', '', '', 'WB', NULL, NULL, NULL),
	(14, '8', 249, 18, 1000000, 0, 0, '', '', '', '', '', '1', '2018-03-10 12:03:56', '2018-03-10 00:00:00', 'New', '', '', '', '', NULL, NULL, NULL),
	(15, '9', 249, 0, 1000000, 0, 0, '', '', '', '', '', '1', '2018-03-10 12:06:05', '2018-03-10 00:00:00', 'New', '', '', '', '', NULL, NULL, NULL),
	(16, '6', 249, 22, 1000000, 0, 0, '', '', '', '', '', '1', '2018-03-10 12:07:22', '2018-03-10 00:00:00', 'New', '', '', '', '', 'aibon', NULL, NULL),
	(17, '10', 249, 0, 1000000, 100, 10, '', '', '', '', '', '1', '2018-07-03 17:27:49', '2018-03-10 00:00:00', 'New', '', '', '', '', NULL, NULL, NULL),
	(18, '5', 254, 0, 0, 0, 0, '', '', '', '', '', '', '2018-04-24 16:31:04', '0000-00-00 00:00:00', 'New', '', '', '', '', NULL, NULL, NULL),
	(19, '5', 254, 26, 175000, 0, 0, 'DUPLEX 400 72 X 102', '', '', '', 'SISIR KELILING ', '1', '2018-04-24 16:31:06', '2018-04-24 00:00:00', 'New', '72 X 102', 'Perhatikan Ukuran Potong kertas ', '65 x 95', '', NULL, '1', NULL),
	(20, '5', 277, 26, 14500, 14600, 100, 'ivory 250', '', '', '', 'yang rapih', '1', '2018-08-11 12:12:35', '2018-08-11 00:00:00', 'Finish', '', '', '', '', NULL, '1', '34'),
	(21, '1', 277, 1, 14500, 14500, 5, '', '', '', '', '', '1', '2018-08-11 12:21:53', '2018-08-11 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '12'),
	(22, '2', 277, 4, 14500, 14500, 6, '', '', '', '', '', '1', '2018-08-11 12:22:35', '2018-08-10 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '37'),
	(23, '8', 277, 19, 14500, 14500, 30, '', '', '', '', '', '1', '2018-08-11 12:23:14', '2018-08-11 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '18'),
	(24, '9', 277, 0, 262500, 0, 0, '', '', '', '', '', '1', '2018-08-11 12:17:13', '2018-08-11 00:00:00', 'New', '', '', '', '', NULL, NULL, '9'),
	(25, '6', 277, 20, 262500, 0, 0, '', '', '', '', '', '1', '2018-08-11 12:17:47', '2018-08-11 00:00:00', 'New', '', '', '', '', NULL, NULL, '30'),
	(26, '10', 277, 0, 262500, 262500, 0, '', '', '', '', '', '1', '2018-08-11 14:14:34', '0000-00-00 00:00:00', 'Finish', '', '', '', '', NULL, NULL, '8');
...
-- Dumping data for table big.users: ~0 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'admin', '$2y$08$v.Lr4yujxQxzZNdmCpgJWu7WLR5hzFDxkh0mRRmSuBartWDE93ySO', '', 'admin@admin.com', NULL, 'asGsHoh0iWTpOuVLM.EMUO900526bdd0557906ac', 1421981304, NULL, 1268889823, 1534667441, 1, 'Admin', 'System', 'ADMIN', '1234567890'),
	...
	(3, '::1', 'operatormesin', '$2y$08$uCPwxQzinDZJTNpyrHeKSetUh/qoePhOdo8t022CCXRu3JBI6nRLO', NULL, 'operatormesin@bigrafis.com', NULL, NULL, NULL, NULL, 1519044464, 1533972759, 1, 'operator', 'mesin', NULL, '666666666'),
	(4, '::1', 'gudang', '$2y$08$DWj0X.FrPCZoWdZ4UTYhY.c6V4z7QU2kUh6I3X/ucV.bJ5D3Ak88W', NULL, 'gu@dang.com', NULL, NULL, NULL, NULL, 1519189506, 1523155521, 1, 'gu', 'dang', NULL, '111111111'),
	(5, '::1', 'sales', '$2y$08$wlvLXmNhk8lKZljeOWhUBeNhGsELLT.pnGR55uwtSFoIqeFMVVZoW', NULL, 'sales@bigrafis.com', NULL, NULL, NULL, NULL, 1523155390, 1534667464, 1, 'sales', 'bigrafis', NULL, '6768696999'),
	(6, '::1', 'production', '$2y$08$drUcxYf2GJXUcdapTiULBOKxY1ugkDAF1EcaLtSA7BJ1aFC/zFM4O', NULL, 'product@bigrafis.com', NULL, NULL, NULL, NULL, 1523155631, 1523155894, 1, 'product', 'unit', NULL, '30928094823');
...
-- Dumping data for table big.users_groups: ~0 rows (approximately)
...
CREATE TABLE `view_report_spk_mesin` (
	...
	`qty_order` INT(11) NOT NULL,
	`qty_finish` INT(11) NOT NULL,
	`qty_good` VARCHAR(12) NOT NULL COLLATE 'utf8mb4_general_ci',
	`qty_reject` INT(11) NOT NULL,
	`persen` VARCHAR(19) NULL COLLATE 'utf8_general_ci',
	`mesin_name` VARCHAR(50) NULL COLLATE 'latin1_swedish_ci',
